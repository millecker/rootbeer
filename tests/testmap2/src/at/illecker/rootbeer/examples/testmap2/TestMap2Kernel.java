 ...
 */
package at.illecker.rootbeer.examples.testmap2;
...
public class TestMap2Kernel implements Kernel {
  ...
  public static void main(String[] args) {
    ...
    TestMap2Kernel kernel = new TestMap2Kernel(GRID_SIZE);
