...
# Run GPU Kernel
# java -Xmx4G -jar OnlineCF3-GPU.jar \
...
# java -Xmx4G -jar OnlineCF3-GPU.jar 256 14 3 150 true

# java -Xmx4G -jar OnlineCF3-GPU.jar 256 14 3 1 false false false \
  0.001 0 0 0 \
...
# java -Xmx16G -jar OnlineCF3-GPU.jar 256 14 3 1 false false false \
  0.001 0 0 0 \
