...
public class OnlineCF {
  ...
  public HashMap<Long, double[]> m_usersMatrix;
  public HashMap<Long, double[]> m_itemsMatrix;
  ...
  public OnlineCF(List<double[]> preferences,
      HashMap<Long, double[]> usersMatrix, HashMap<Long, double[]> itemsMatrix,
